---
title: 'Draft: Contra David Deutsch on AI'
image: ../assets/deutsch-meme.jpg
date: 2022-01-10
draft: false
---

I'm interviewing David Deutsch on my [podcast]() soon. Please email me at dwarkesh@dwarkeshpatel.com if you have any suggestions for what questions I should ask him, or if you feedback on this post.
...
_The universal explainers hypothesis is incorrect because it cannot explain why some animals are smart and some humans are stupid. Furthermore, it is meaningless when we consider the disparities between different computers and irrelevant to the extent that it is compatible with powerful AIs with narrow objective functions._
...
2. Even if this theory can explain how animals can combine different elementary subtasks in order to perform complex behaviors, it still doesn’t explain how animals can execute these basic subtasks without creativity. Take the example of a gorilla stripping nettle plant leaves from their stem. Even this basic action requires cycles of conjecture and refutation which Deutsch believes exemplify creativity [fix]. She conjectures that pulling at a certain angle will separate the leaves from the stem without damaging them, but she is refuted when the leaves on the left side of the stem start to crumple. She conjectures that pulling with a certain force will maximize her speed without injuring the plant, but she is refuted when she feels the stem on the verge of snapping. There are a dozen such microcycles of error-correction.
...
Deutsch might respond that ants are not running the universal explainer software, and without it, there is nothing for extra memory and speed to scale. Since humans already have this software, all that''s required for us to catch up to future AIs are tools or augmentation which give us more compute than the brain can natively provide.

I have explained why I think the idea of universal explainers is wrong in the sections above, so I am not convinced that the repertoire of human thought is wide enough to accommodate all the knowledge of neuromodulation necessary to catch up hardware-wise with AIs.
...
Admittedly, this is not a full explanation. Saying that intelligence is a matter of training a very large neural net with lots of diverse experiences is like nuclear fusion is a matter of the interactions between fermions and bosons - it may be true but it is not much of an explanation. But David Deutsch doesn't have an explanation for why the universal explainers hypothesis is correct either. Such an explanation is impossible until we actually understand what general intelligence is and how it can be constructed.
...
- Deep learning has scaled remarkably well over the last ten years, being able top perform difficult general tasks without supervised learning.
  - If being a universal explainer is necessary to address problems which require novel solutions within a large search space, then why have we be able to solve problems like protein folding, writing poetry, creating art, beating the best Go players, discovering new drugs, (100 other really impressive examples) just by increasing the compute and training data we provide to general-purpose neural nets? And if you don't need to be a universal explainer to in order to solve these problems, then why should we care about universal explainers?

Meanwhile, the scaling hypothesis can address he problems which the universal explainers hypothesis was created to solve:
...
Given that we don't have a full theory of intelligence, I would not be surprised if the universal explainers hypothesis is correct, and the maximum possible intelligence is close to human-level. But I think this theory has problems which can be solved by the scaling hypothesis, which anticipates much greater gains in cognition in AGIs. Since the scaling hypothesis might be correct, we ought to take the concerns of AI safety advocates much more seriously. If Deutsch is correct that hard coding our values into AGIs is an unethical way to create friendly AI, then we ought to figure out how to persuade beings which might be much smarter than us and will not share the moral intuitions which humans genetically recieve.

# Appendix

## Contra Deutsch on IQ

Deutsch criticizes the broad reaching conclusions about the heritability of traits from behavioral studies:
...
His objections are not valid with regards to IQ:
...
- How do even know that measured intelligence is telling us something real and generalizable which corresponds to abstract thinking, problem solving ability, and capacity to acquire knowledge? As Deutsch asks in the analogous happiness example, "how can we measure whether different people’s ratings of their own psychological state are commensurable?"
  ...
  - If a measure that accurately predicts test scores, educational attainement, job performance, and income
...
- Do we actually have any explanations for why differences in the brain could cause disparities in intelligence, and why such differences would be heritable? Or as Deutsch puts it with regards to happiness, "no behavioural study can detect whether happiness is inborn or not. Science simply cannot resolve that issue until we have explanatory theories about what objective attributes people are referring to when they speak of their happiness, and also about what physical chain of events connects genes to those attributes."
  ...
  - Here are just some of the biological differences in brains which are correlated with differences in intelligence and which are obviously causally linked to cognitive power, quoted from Stuart Richie's _Intelligence: All That Matters_:
    ...
    Of course, we should expect such traits to be at least partially heritable. If you want to claim that they are not heritable at all, then the onus is on you to explain why all aspects of biological life except for the topography, size, and organization of human brains are partially heritable. [fix]
...
- How do we know that the apparent heritability of intelligence isn't instead caused by some X trait which is itself heritable and causes disparities in intelligence by influencing how society treats people with that trait or how people with that trait develop and express their cognitive potential? Deutsch gives the following alternative explanations with regards to happiness, "if we were to find that people with a particular gene tend to rate themselves happier than people without it, how can we tell whether the gene is coding for happiness? Perhaps it is coding for less reluctance to _quantify_ one’s happiness. Perhaps the gene in question does not affect the brain at all, but only how a person looks, and perhaps better-looking people are happier on average because they are treated better by others. There is an infinity of possible explanations."
  ...
  - As Deutsch has explained, in science you can never prove an explanation. You just have to find a theory which is hard-to-vary and best explains the evidence. There is no plausible alternative explanation which accounts for why adopted twins raised in different households in different social classes and cultures are still much more likely to have similar IQ scores than two random members of the general population. If he has an alternative explanation to the mountains of research which show that g is real, heritable, and predictive of intelligence relevant outcomes, then he is free to provide it.
    ...
    With regards to a possible confounding trait to intelligence analogous to good looks to happiness, Deutsch has to explain, what is this X trait could ne which is:
