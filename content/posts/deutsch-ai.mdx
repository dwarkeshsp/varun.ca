...
Given that we don't have a full theory of intelligence, I would not be surprised if the universal explainers hypothesis is correct, and that the maximum possible intelligence is close to human-level. But the scaling hypothesis is tentatively a better model because it resolves many problems which the universal explainers hypothesis faces. At the very least, we can't rule out the scaling hypothesis, and we ought to prepare for the possibility of a fundamentally superhuman artificial intelligence [TODO better conclusion]. 
