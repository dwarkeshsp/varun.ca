...
*I'm interviewing David Deutsch on my podcast in a few days. Email me at dwarkesh@dwarkeshpatel.com if you have any suggestions for questions that I should ask him.*
...
Deutsch might respond that ants are not running the universal explainer software, and without it, there is nothing for extra memory and speed to scale. Since humans already have this software, all that''s required for us to catch up to future AIs are either external tools or brain augmentations which give us more compute than the brain can natively provide.
...
The intelligence of smart animals and stupid humans seem to exist in a strict but nonempty subset of the intelligence of the smartest humans. Since the principles of neuroimaging and mind-upload are impossible to grasp for all animals and at least some humans, part of what is excluded from that set is the knowledge of how to expand that set. If it possible for beings to exist in subsets of intelligence that do not contain the tools by which to expand out into their immediate superset, then maybe even smart humans live in such a subset, and the cognitive repertoire of superhuman AIs evades them.
...
Admittedly, this is not a full explanation. Saying that intelligence is a matter of training a very large neural net with lots of diverse experiences is like saying that nuclear fusion is a matter of the interactions between fermions and bosons - it may be true but it is not much of an explanation. However, David Deutsch doesn't have an explanation for why the universal explainers hypothesis is correct either. Such an explanation is impossible until we actually understand what general intelligence is and how it can be constructed.
