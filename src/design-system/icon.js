...
const iconsMap = {
  ...
  'arrow-left': (props) => (
    <SVG width="1em" height="1em" viewBox="0 0 20 20" {...props}>
      <path
        fill="currentColor"
        d="M18.27 10.788H3.616l4.184 4.184a.78.78 0 010 1.107.781.781 0 01-1.106 0l-5.481-5.482c-.018-.014-.037-.019-.053-.034a.766.766 0 01-.21-.66c.005-.038.013-.07.022-.109a.746.746 0 01.143-.27c.02-.027.02-.062.045-.086.015-.016.034-.02.05-.033l5.484-5.483a.78.78 0 011.106 0 .778.778 0 010 1.105L3.615 9.212H18.27a.788.788 0 110 1.576z"
      ></path>
    </SVG>
  ),
